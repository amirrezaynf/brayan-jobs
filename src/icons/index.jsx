...
export const StarIcon = ({ className = "", filled = false, ...props }) => (
  ...
  >
    {filled ? (
      <path
        fill="currentColor"
        d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 0 0 .95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 0 0-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 0 0-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 0 0-.363-1.118L3.076 10.1c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 0 0 .951-.69l1.52-4.673Z"
      />
    ) : (
      <path
        fill="none"
...
export const SpecializationIcon = ({ className = "", ...props }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
...
export const BellIcon = ({ className = "", ...props }) => (
  ...
  >
    ...
    <path d="M9 18v1a3 3 0 1 0 6 0v-1" />
  </svg>
);
...
export const CheckCircleGoldIcon = ({ className = "", ...props }) => (
  <svg
    className={className}
    fill="none"
    stroke="currentColor"
