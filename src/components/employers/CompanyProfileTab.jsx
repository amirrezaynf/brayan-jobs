...
import { Building2, MapPin, Phone, Mail, Globe, Users, Calendar, Upload, Save, Camera, Star, Award, Trash2 } from 'lucide-react';
    ...
    <div className="mb-4">
      ...
      <div className="flex items-center gap-4">
        <div className="w-20 h-20  border border-gray-600 rounded-lg flex items-center justify-center overflow-hidden">
          {currentImage ? (
            <img src={currentImage} alt="Company" className="w-full h-full object-cover" />
          ) : (
...
export default function CompanyProfileTab() {
  const [companyData, setCompanyData] = useState({
    ...
    // Company Description
    description: 'شرکت پیشرو در زمینه توسعه نرم‌افزار و خدمات فناوری اطلاعات با بیش از 8 سال تجربه در ارائه راهکارهای نوآورانه به کسب‌وکارها.',
    vision: 'تبدیل شدن به پیشرو در ارائه راهکارهای فناوری اطلاعات در منطقه',
    mission: 'کمک به کسب‌وکارها برای دیجیتالی شدن و بهبود فرآیندهای خود از طریق فناوری‌های نوین',
    ...
    // Company Culture
    benefits: ['بیمه تکمیلی', 'ساعت کاری منعطف', 'امکان کار از راه دور', 'آموزش‌های تخصصی', 'محیط کاری دوستانه'],
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <FormSection title="درباره شرکت" icon={Award}>
        <FormField label="معرفی شرکت" required description="توضیح کاملی از فعالیت‌های شرکت ارائه دهید">
          <textarea
