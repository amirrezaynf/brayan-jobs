...
import {
  getUserActiveVacancies,
  getUserExpiredVacancies,
  deleteVacancy,
} from "@/app/actions/vacancy";
      ...
      if (result.success) {
        ...
        const mappedVacancies = result.data.map((vacancy) => {
          ...
          return {
            ...
            title: vacancy.title,
            company:
              vacancy.company?.display_name ||
              vacancy.company?.name ||
              "شرکت نامشخص",
            date: vacancy.published_at
              ? new Date(vacancy.published_at).toLocaleDateString("fa-IR")
              : vacancy.created_at
